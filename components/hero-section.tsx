...
//             <Button asChild size="lg" className="text-lg px-8 py-6 bg-primary hover:bg-primary/90 shadow-xl">
//               <a
...
//               variant="outline"
//               size="lg"
//               className="text-lg px-8 py-6 border-white text-white hover:bg-white hover:text-foreground bg-transparent backdrop-blur-sm"
//             >
...
//         <div
//           className={`grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-16 transition-all duration-1000 delay-500 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
//         >
//           <div className="flex flex-col items-center text-center p-4 rounded-lg glass">
